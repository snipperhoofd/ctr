...
transcriptional_responses$Run(iterations = 1000,
                              ...
                              parallel_cores = 4)
#All_association_matrix <- transcriptional_responses$AssociationMatrix_perModule(list_of_all_modules, list_of_all_modules_KOs)
```
