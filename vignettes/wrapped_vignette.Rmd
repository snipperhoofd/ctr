...
plot(table(lengths(sublist_of_all_modules)))
```
...
for(i in 1: 6){
  transcriptional_responses$bg_distance_modules[[as.character(i)]] <- 
    Background_Distribution_Modules(transcriptional_responses$RNAseq_Annotated_Matrix,
...
pruned <- ClusterPrune(transcriptional_responses$clustering_results_P_NRED,
                            transcriptional_responses$bg_distance_modules,
                            sublist_of_all_modules)

ass_matrix <- fill_association_matrix(pruned,transcriptional_responses$matrix_features,
                            sublist_of_all_modules)
