...
sublist_of_all_modules_KOs <- unique(unlist(subset_of_all_modules, use.names=FALSE))
...
transcriptional_responses$AssociationMatrix(sublist_of_all_modules_KOs, sublist_of_all_modules)
