...
subset_of_all_modules <-  make_module_lists(KO_modules_table2)[1:2]
subset_of_all_modules_KOs <- unique(unlist(subset_of_all_modules, use.names=FALSE))
...
transcriptional_responses$bg_distance_modules[[1]][which(transcriptional_responses$bg_distance_modules[[1]]!=0)]
```
