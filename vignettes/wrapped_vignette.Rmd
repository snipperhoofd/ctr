...
transcriptional_responses$Run(iterations = 1000, # more would be better e.g. 10k
                              random_module_sizes = 1:10,# more would be better e.g. 1:20
                              parallel_cores = 3) # more is better, depending on the pc's hardware
...
association_rules$run_apriori(supp = 0.4, conf = 0.9 )
