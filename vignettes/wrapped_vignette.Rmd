...
missing_modules<-which(colSums(transcriptional_responses$All_association_matrix,na.rm=TRUE)==0)
# remove them from downstreamstream analysis
transcriptional_responses$All_association_matrix<-transcriptional_responses$All_association_matrix[,-as.numeric(missing_modules)]
```
