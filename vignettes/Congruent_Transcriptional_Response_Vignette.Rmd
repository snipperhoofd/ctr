...
Random_Background_Module_Distances_6_BR<-Background_Distribution_Modules(RNAseq_Annotated_Matrix_BR_default_bin, 
                                                                         Z_scores_BR, 6, 100)
Random_Background_Module_Distances_7_BR<-Background_Distribution_Modules(RNAseq_Annotated_Matrix_BR_default_bin, 
                                                                         Z_scores_BR, 7, 100)
Random_Background_Module_Distances_8_BR<-Background_Distribution_Modules(RNAseq_Annotated_Matrix_BR_default_bin,
                                                                         Z_scores_BR, 8, 100)

Random_Background_Module_Distances_6_B<-Background_Distribution_Modules(RNAseq_Annotated_Matrix_B_default_bin, 
                                                                        Z_scores_B, 6, 100)
Random_Background_Module_Distances_7_B<-Background_Distribution_Modules(RNAseq_Annotated_Matrix_B_default_bin,
                                                                        Z_scores_B, 7, 100)
Random_Background_Module_Distances_8_B<-Background_Distribution_Modules(RNAseq_Annotated_Matrix_B_default_bin,
                                                                        Z_scores_B, 8, 100)
