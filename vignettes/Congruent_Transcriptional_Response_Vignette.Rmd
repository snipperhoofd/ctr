...
matrix_features_B <- new("General_features",
                       ...
                       All_KOs = names(table(RNAseq_Annotated_Matrix_B$KO))[-which(names((table(RNAseq_Annotated_Matrix_B$KO)))=="")]
                       )
...
matrix_features_BR <- new("General_features",
                       ...
                       All_KOs = names(table(RNAseq_Annotated_Matrix_BR$KO))[-which(names((table(RNAseq_Annotated_Matrix_BR$KO)))=="")]
                       )
```
...
I_KOs_Background_B <-  Individual_KOs_Background(RNAseq_Annotation_Matrix_no_sd_of_zero_B, matrix_features_B, 10000, language = 'C')
I_KOs_Background_BR <- Individual_KOs_Background(RNAseq_Annotation_Matrix_no_sd_of_zero_BR,matrix_features_BR,10000, language = 'C')

#benchmarks3 <- rbenchmark::benchmark(replications = 2,
 #                     Individual_KOs_Background(RNAseq_Annotation_Matrix_no_sd_of_zero_B,matrix_features_B,10000, language = 'C'),
  #                    Individual_KOs_Background(RNAseq_Annotation_Matrix_no_sd_of_zero_B,matrix_features_B,10000, language = 'R'))
