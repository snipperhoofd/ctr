...
### E) Calculating statistics for each module
...
RNAseq_Annotated_Matrix<-read.table("sample_data/EBPR_RNAseq_Annotation_Matrix",sep="\t",quote = "", row.names = NULL, stringsAsFactors = FALSE, fill = TRUE)
```
...
unmapped_reads<-no_feature+ ambiguous+ not_aligned
...
RNAseq_Annotated_Matrix_default<-RNAseq_Normalize(RNAseq_Annotated_Matrix,no_feature,ambiguous,not_aligned)
RNAseq_Annotated_Matrix_default_by_bin<-Normalize_by_bin(RNAseq_Annotated_Matrix_default)
