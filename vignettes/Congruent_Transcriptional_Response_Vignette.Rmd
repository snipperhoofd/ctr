...
KO_modules_table2<-read.table("sample_data/KEGG_Modules_14_04_2017.txt_tab_delimited",sep="\t",quote = "", row.names = NULL, stringsAsFactors = FALSE)
...
valine_isoleucine<- KO_modules_table[which(KO_modules_table$V1=="M00019"),2]
isoleucine<- KO_modules_table[which(KO_modules_table$V1=="M00535"),2]
isoleucine2<- KO_modules_table[which(KO_modules_table$V1=="M00570"),2]
Leucine<-KO_modules_table[which(KO_modules_table$V1=="M00432"),2]
```
...
matrix_features <- new("General_features",
                       ...
                       RS = which(colnames(RNAseq_Annotated_Matrix) == "Bin") + 1,
                       RE = which(colnames(RNAseq_Annotated_Matrix) == "Bin") + length(sample_names),
...
RNAseq_Annotated_Matrix_B_default<-RNAseq_Normalize(RNAseq_Annotated_Matrix_B,no_feature_B,ambiguous_B,not_aligned_B)
RNAseq_Annotated_Matrix_B_default_bin<-Normalize_by_bin(RNAseq_Annotated_Matrix_B_default)

RNAseq_Annotated_Matrix_BR_default<-RNAseq_Normalize(RNAseq_Annotated_Matrix_BR,no_feature,ambiguous,not_aligned)
RNAseq_Annotated_Matrix_BR_default_bin<-Normalize_by_bin(RNAseq_Annotated_Matrix_BR_default)
...
RNAseq_Annotated_Matrix_B_default<-Create_Rank_Columns(RNAseq_Annotated_Matrix_B_default)
set.seed(1396558)
RNAseq_Annotated_Matrix_B_default_bin<-Create_Rank_Columns(RNAseq_Annotated_Matrix_B_default_bin)

set.seed(1396558) # ties are dealt with randomly, so set.seed must be used to ensure reproducibility
RNAseq_Annotated_Matrix_BR_default<-Create_Rank_Columns(RNAseq_Annotated_Matrix_BR_default)
set.seed(1396558)
RNAseq_Annotated_Matrix_BR_default_bin<-Create_Rank_Columns(RNAseq_Annotated_Matrix_BR_default_bin)



kable(RNAseq_Annotated_Matrix_BR_default_bin[1:5,], caption = "Data with Rank Column added")
...
I_KOs_Background_B <- Individual_KOs_Background(RNAseq_Annotation_Matrix_no_sd_of_zero_B,10000)
I_KOs_Background_BR <- Individual_KOs_Background(RNAseq_Annotation_Matrix_no_sd_of_zero_BR,10000)
...
plot(hexbin(Z_scores_B$Z_H_random), colramp=rf, mincnt=1, maxcnt=60,ylab="NRED",xlab="PC")
plot(hexbin(Z_scores_B$Z_H_KO), colramp=rf, mincnt=1,maxcnt=60,ylab="NRED",xlab="PC")

plot(hexbin(Z_scores_BR$Z_H_random), colramp=rf, mincnt=1, maxcnt=60,ylab="NRED",xlab="PC")
plot(hexbin(Z_scores_BR$Z_H_KO), colramp=rf, mincnt=1,maxcnt=60,ylab="NRED",xlab="PC")
```
...
Random_Background_Module_Distances_6_BR<-Background_Distribution_Modules(RNAseq_Annotated_Matrix_BR_default_bin,6,10000)
Random_Background_Module_Distances_7_BR<-Background_Distribution_Modules(RNAseq_Annotated_Matrix_BR_default_bin,7,10000)
Random_Background_Module_Distances_8_BR<-Background_Distribution_Modules(RNAseq_Annotated_Matrix_BR_default_bin,8,10000)

Random_Background_Module_Distances_6_B<-Background_Distribution_Modules(RNAseq_Annotated_Matrix_B_default_bin,6,10000)
Random_Background_Module_Distances_7_B<-Background_Distribution_Modules(RNAseq_Annotated_Matrix_B_default_bin,7,10000)
Random_Background_Module_Distances_8_B<-Background_Distribution_Modules(RNAseq_Annotated_Matrix_B_default_bin,8,10000)
...
PHA_module_P_NRED_B <- P_NRED_Distance_Function(RNAseq_Annotated_Matrix_B_default_bin,PHA_module)
...
Glycogen_module_P_NRED_B <- P_NRED_Distance_Function(RNAseq_Annotated_Matrix_B_default_bin,Glycogen_module)
...
polyP_module_P_NRED_B <- P_NRED_Distance_Function(RNAseq_Annotated_Matrix_B_default_bin,polyP_module)
...
# than for BR
PHA_module_P_NRED_BR <- P_NRED_Distance_Function(RNAseq_Annotated_Matrix_BR_default_bin,PHA_module)
...
Glycogen_module_P_NRED_BR <- P_NRED_Distance_Function(RNAseq_Annotated_Matrix_BR_default_bin,Glycogen_module)
...
polyP_module_P_NRED_BR <- P_NRED_Distance_Function(RNAseq_Annotated_Matrix_BR_default_bin,polyP_module)
...
Leucine_module_P_NRED_BR <- P_NRED_Distance_Function(RNAseq_Annotated_Matrix_BR_default_bin,Leucine)
Jaccard_Distance_Leucine_BR <- Jaccard_Distance_Function(RNAseq_Annotated_Matrix_BR_default_bin,Leucine)
Leucine_clustering_results_P_NRED_BR <-cluster_func(Leucine_module_P_NRED_BR$combined,Jaccard_Distance_Leucine_BR)
