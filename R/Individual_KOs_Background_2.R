...
Individual_KOs_Background <- function(RNAseq_Annotation_Matrix_no_sd_of_zero, matrix_features, N){
  ...
  for (x in 1:N) {
    ...
    random_pairwise_gene_euclidean[x]<- Calc_Norm_Euc(as.numeric(RNAseq_Annotation_Matrix_no_sd_of_zero[position_of_A, matrix_features@RS:matrix_features@RE]),
                                                     as.numeric(RNAseq_Annotation_Matrix_no_sd_of_zero[position_of_B, matrix_features@RS:matrix_features@RE]))
    #
    ...
    # m1
    KO_pairwise_gene_correlation[x]<-cor(as.numeric(RNAseq_Annotation_Matrix_no_sd_of_zero[sample_KO_position_of_A,matrix_features@SS:matrix_features@SE]),as.numeric(RNAseq_Annotation_Matrix_no_sd_of_zero[sample_KO_position_of_B,matrix_features@SS:matrix_features@SE]))
    KO_pairwise_gene_euclidean[x]<-Calc_Norm_Euc(as.numeric(RNAseq_Annotation_Matrix_no_sd_of_zero[sample_KO_position_of_A,matrix_features@RS:matrix_features@RE]),as.numeric(RNAseq_Annotation_Matrix_no_sd_of_zero[sample_KO_position_of_B,matrix_features@RS:matrix_features@RE]))
    # m2
